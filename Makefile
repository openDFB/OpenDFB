...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in $(srcdir)/directfb-config.in \
	$(srcdir)/directfb.pc.in $(srcdir)/directfb-internal.pc.in \
	$(srcdir)/directfb.spec.in COPYING TODO compile config.guess \
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = data docs include lib src lib/sawman lib/divine tools \
	systems wm interfaces inputdrivers gfxdrivers proxy tests \
	patches rules build-android
...
CFLAGS = -Wall -Wstrict-prototypes -Wmissing-prototypes -Wno-strict-aliasing -Werror-implicit-function-declaration -O3 -g2 -ffast-math -pipe  -D_GNU_SOURCE  -finstrument-functions -std=gnu99 -Werror-implicit-function-declaration
CPP = gcc -E
CPPFLAGS = -D_REENTRANT 
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -Wall -Wno-strict-aliasing -g -O2 -O3 -g2 -ffast-math -pipe  -D_GNU_SOURCE  -finstrument-functions
CYGPATH_W = echo
DATADIR = ${datarootdir}/directfb-1.6.3
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DEP_ONE = one
DEP_VOODOO = 
...
SHELL = /bin/bash
SOPATH = ${exec_prefix}/lib/libdirectfb-1.6.so.3
STRIP = strip
SVG_CFLAGS = 
SVG_LIBS = 
SYSCONFDIR = /opt/opendfb/etc
...
X11_LIBS = -lX11 -lXext 
ZLIB_LIBS = 
abs_builddir = /home/kin/workspace/opendfb-workspace/DirectFB-1.6.3-mini
abs_srcdir = /home/kin/workspace/opendfb-workspace/DirectFB-1.6.3-mini
abs_top_builddir = /home/kin/workspace/opendfb-workspace/DirectFB-1.6.3-mini
abs_top_srcdir = /home/kin/workspace/opendfb-workspace/DirectFB-1.6.3-mini
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kin/workspace/opendfb-workspace/DirectFB-1.6.3-mini/install-sh
