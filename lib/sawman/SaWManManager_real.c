...
DFBResult
ISaWManManagerReal_Activate(ISaWManManagerX *thiz
)
{
...
DFBResult
ISaWManManagerReal_QueueUpdate(ISaWManManagerX *thiz,
...
DFBResult
ISaWManManagerReal_ProcessUpdates(ISaWManManagerX *thiz,
...
DFBResult
ISaWManManagerReal_CloseWindow(ISaWManManagerX *thiz,
                    SaWManWindow *window
)
{
...
DFBResult
ISaWManManagerReal_InsertWindow(ISaWManManagerX *thiz,
                    SaWManWindow         *window,
...
DFBResult
ISaWManManagerReal_RemoveWindow(ISaWManManagerX *thiz,
                    SaWManWindow         *window
)
{
     DFBResult ret;
...
DFBResult
ISaWManManagerReal_SwitchFocus(ISaWManManagerX *thiz,
                    SaWManWindow         *window
)
{
     DFBResult ret;
...
DFBResult
ISaWManManagerReal_SetScalingMode(ISaWManManagerX *thiz,
...
DFBResult
ISaWManManagerReal_SetWindowConfig(ISaWManManagerX *thiz,
                    SaWManWindow             *sawwin,
                    ...
                    SaWManWindowConfigFlags   flags )
{
     ...
     dfb_wm_dispatch_WindowConfig( thiz->core, window, (DFBWindowConfigFlags) flags );
...
DFBResult
ISaWManManagerReal_IsShowingWindow(ISaWManManagerX *thiz,
                    SaWManWindow         *window,
...
void ISaWManManagerRealInit(ISaWManManagerXReal *thiz, CoreDFB *core, SaWManManager *obj)
{
	...
	thiz->base.Activate = ISaWManManagerReal_Activate;
	thiz->base.QueueUpdate = ISaWManManagerReal_QueueUpdate;
	thiz->base.ProcessUpdates = ISaWManManagerReal_ProcessUpdates;
	thiz->base.CloseWindow = ISaWManManagerReal_CloseWindow;
	thiz->base.InsertWindow = ISaWManManagerReal_InsertWindow;
	thiz->base.RemoveWindow = ISaWManManagerReal_RemoveWindow;
	thiz->base.SwitchFocus = ISaWManManagerReal_SwitchFocus;
	thiz->base.SetScalingMode = ISaWManManagerReal_SetScalingMode;
	thiz->base.SetWindowConfig = ISaWManManagerReal_SetWindowConfig;
	thiz->base.IsShowingWindow = ISaWManManagerReal_IsShowingWindow;
}
