...
#define DirectFBKeySymbolNames(Identifier) struct DFBKeySymbolName Identifier[] = { \
     ...
     { DIKS_POWER2, "POWER2" }, \
     { DIKS_SLEEP, "SLEEP" }, \
     { DIKS_DISPLAY_MODE, "DISPLAY_MODE" }, \
     { DIKS_ASPECT, "ASPECT" }, \
     { DIKS_OPTION, "OPTION" }, \
     { DIKS_MENU, "MENU" }, \
     { DIKS_HELP, "HELP" }, \
     ...
     { DIKS_PC, "PC" }, \
     { DIKS_SCREEN, "SCREEN" }, \
     { DIKS_INPUT_METHOD, "INPUT_METHOD" }, \
     { DIKS_VOICE, "VOICE" }, \
     { DIKS_KEY_MOUSE, "KEY_MOUSE" }, \
     { DIKS_TV, "TV" }, \
     { DIKS_TV2, "TV2" }, \
     { DIKS_VCR, "VCR" }, \
     { DIKS_VCR2, "VCR2" }, \
     ...
     { DIKS_EDITOR, "EDITOR" }, \
     { DIKS_STOCK, "STOCK" }, \
     { DIKS_WEATHER, "WEATHER" }, \
     { DIKS_APP_STORE, "APP_STORE" }, \
     { DIKS_RED, "RED" }, \
     { DIKS_GREEN, "GREEN" }, \
     { DIKS_YELLOW, "YELLOW" }, \
     { DIKS_BLUE, "BLUE" }, \
     ...
     { DIKS_MOVE, "MOVE" }, \
     { DIKS_STILL, "STILL" }, \
     { DIKS_PICTURE_MODE, "PICTURE_MODE" }, \
     { DIKS_SOUND_MODE, "SOUND_MODE" }, \
     { DIKS_3DSTEREO, "3DSTEREO" }, \
     { DIKS_CALL, "CALL" }, \
