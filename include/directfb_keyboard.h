...
typedef enum {
     ...
     DIKS_SLEEP                    = DFB_KEY( SPECIAL, 0x11 ),
     DIKS_DISPLAY_MODE             = DFB_KEY( SPECIAL, 0x12 ),
     DIKS_ASPECT                   = DFB_KEY( SPECIAL, 0x13 ),

     DIKS_OPTION                   = DFB_KEY( SPECIAL, 0x14 ),
     DIKS_MENU                     = DFB_KEY( SPECIAL, 0x15 ),
     DIKS_HELP                     = DFB_KEY( SPECIAL, 0x16 ),
     DIKS_INFO                     = DFB_KEY( SPECIAL, 0x17 ),
     DIKS_TIME                     = DFB_KEY( SPECIAL, 0x18 ),
     DIKS_VENDOR                   = DFB_KEY( SPECIAL, 0x19 ),
     DIKS_MORE                     = DFB_KEY( SPECIAL, 0x1A ),
     DIKS_SEARCH                   = DFB_KEY( SPECIAL, 0x1B ),

     DIKS_ARCHIVE                  = DFB_KEY( SPECIAL, 0x1C ),
     DIKS_PROGRAM                  = DFB_KEY( SPECIAL, 0x1D ),
     DIKS_CHANNEL                  = DFB_KEY( SPECIAL, 0x1E ),
     DIKS_FAVORITES                = DFB_KEY( SPECIAL, 0x1F ),
     DIKS_EPG                      = DFB_KEY( SPECIAL, 0x20 ),
     DIKS_PVR                      = DFB_KEY( SPECIAL, 0x21 ),
     DIKS_MHP                      = DFB_KEY( SPECIAL, 0x22 ),
     DIKS_LANGUAGE                 = DFB_KEY( SPECIAL, 0x23 ),
     DIKS_TITLE                    = DFB_KEY( SPECIAL, 0x24 ),
     DIKS_SUBTITLE                 = DFB_KEY( SPECIAL, 0x25 ),
     DIKS_ANGLE                    = DFB_KEY( SPECIAL, 0x26 ),
     DIKS_ZOOM                     = DFB_KEY( SPECIAL, 0x27 ),
     DIKS_MODE                     = DFB_KEY( SPECIAL, 0x28 ),
     DIKS_KEYBOARD                 = DFB_KEY( SPECIAL, 0x29 ),
     DIKS_PC                       = DFB_KEY( SPECIAL, 0x2A ),
     DIKS_SCREEN                   = DFB_KEY( SPECIAL, 0x2B ),
     DIKS_INPUT_METHOD             = DFB_KEY( SPECIAL, 0x2C ),
     DIKS_VOICE                    = DFB_KEY( SPECIAL, 0x2D ),
     DIKS_KEY_MOUSE                = DFB_KEY( SPECIAL, 0x2E ),

     DIKS_TV                       = DFB_KEY( SPECIAL, 0x2F ),
     DIKS_TV2                      = DFB_KEY( SPECIAL, 0x30 ),
     DIKS_VCR                      = DFB_KEY( SPECIAL, 0x31 ),
     DIKS_VCR2                     = DFB_KEY( SPECIAL, 0x32 ),
     DIKS_SAT                      = DFB_KEY( SPECIAL, 0x33 ),
     DIKS_SAT2                     = DFB_KEY( SPECIAL, 0x34 ),
     DIKS_CD                       = DFB_KEY( SPECIAL, 0x35 ),
     DIKS_TAPE                     = DFB_KEY( SPECIAL, 0x36 ),
     DIKS_RADIO                    = DFB_KEY( SPECIAL, 0x37 ),
     DIKS_TUNER                    = DFB_KEY( SPECIAL, 0x38 ),
     DIKS_PLAYER                   = DFB_KEY( SPECIAL, 0x39 ),
     DIKS_TEXT                     = DFB_KEY( SPECIAL, 0x3A ),
     DIKS_DVD                      = DFB_KEY( SPECIAL, 0x3B ),
     DIKS_AUX                      = DFB_KEY( SPECIAL, 0x3C ),
     DIKS_MP3                      = DFB_KEY( SPECIAL, 0x3D ),
     DIKS_PHONE                    = DFB_KEY( SPECIAL, 0x3E ),
     DIKS_AUDIO                    = DFB_KEY( SPECIAL, 0x3F ),
     DIKS_VIDEO                    = DFB_KEY( SPECIAL, 0x40 ),
     DIKS_VOD                      = DFB_KEY( SPECIAL, 0x41 ),
     DIKS_NVOD                     = DFB_KEY( SPECIAL, 0x42 ),

     DIKS_INTERNET                 = DFB_KEY( SPECIAL, 0x43 ),
     DIKS_MAIL                     = DFB_KEY( SPECIAL, 0x44 ),
     DIKS_NEWS                     = DFB_KEY( SPECIAL, 0x45 ),
     DIKS_DIRECTORY                = DFB_KEY( SPECIAL, 0x46 ),
     DIKS_LIST                     = DFB_KEY( SPECIAL, 0x47 ),
     DIKS_CALCULATOR               = DFB_KEY( SPECIAL, 0x48 ),
     DIKS_MEMO                     = DFB_KEY( SPECIAL, 0x49 ),
     DIKS_CALENDAR                 = DFB_KEY( SPECIAL, 0x4A ),
     DIKS_EDITOR                   = DFB_KEY( SPECIAL, 0x4B ),
     DIKS_STOCK                    = DFB_KEY( SPECIAL, 0x4C ),
     DIKS_WEATHER                  = DFB_KEY( SPECIAL, 0x4D ),
     DIKS_APP_STORE                = DFB_KEY( SPECIAL, 0x4E ),

     DIKS_RED                      = DFB_KEY( SPECIAL, 0x4F ),
     DIKS_GREEN                    = DFB_KEY( SPECIAL, 0x50 ),
     DIKS_YELLOW                   = DFB_KEY( SPECIAL, 0x51 ),
     DIKS_BLUE                     = DFB_KEY( SPECIAL, 0x52 ),

     DIKS_CHANNEL_UP               = DFB_KEY( SPECIAL, 0x53 ),
     DIKS_CHANNEL_DOWN             = DFB_KEY( SPECIAL, 0x54 ),
     DIKS_BACK                     = DFB_KEY( SPECIAL, 0x55 ),
     DIKS_FORWARD                  = DFB_KEY( SPECIAL, 0x56 ),
     DIKS_FIRST                    = DFB_KEY( SPECIAL, 0x57 ),
     DIKS_LAST                     = DFB_KEY( SPECIAL, 0x58 ),
     DIKS_VOLUME_UP                = DFB_KEY( SPECIAL, 0x59 ),
     DIKS_VOLUME_DOWN              = DFB_KEY( SPECIAL, 0x5A ),
     DIKS_MUTE                     = DFB_KEY( SPECIAL, 0x5B ),
     DIKS_AB                       = DFB_KEY( SPECIAL, 0x5C ),
     DIKS_PLAYPAUSE                = DFB_KEY( SPECIAL, 0x5D ),
     DIKS_PLAY                     = DFB_KEY( SPECIAL, 0x5E ),
     DIKS_STOP                     = DFB_KEY( SPECIAL, 0x5F ),
     DIKS_RESTART                  = DFB_KEY( SPECIAL, 0x60 ),
     DIKS_SLOW                     = DFB_KEY( SPECIAL, 0x61 ),
     DIKS_FAST                     = DFB_KEY( SPECIAL, 0x62 ),
     DIKS_RECORD                   = DFB_KEY( SPECIAL, 0x63 ),
     DIKS_EJECT                    = DFB_KEY( SPECIAL, 0x64 ),
     DIKS_SHUFFLE                  = DFB_KEY( SPECIAL, 0x65 ),
     DIKS_REWIND                   = DFB_KEY( SPECIAL, 0x66 ),
     DIKS_FASTFORWARD              = DFB_KEY( SPECIAL, 0x67 ),
     DIKS_PREVIOUS                 = DFB_KEY( SPECIAL, 0x68 ),
     DIKS_NEXT                     = DFB_KEY( SPECIAL, 0x69 ),
     DIKS_BEGIN                    = DFB_KEY( SPECIAL, 0x6A ),
     DIKS_SEEK                     = DFB_KEY( SPECIAL, 0x5B ),
     DIKS_TIME_SHIFT               = DFB_KEY( SPECIAL, 0x6C ),

     DIKS_DIGITS                   = DFB_KEY( SPECIAL, 0x6D ),
     DIKS_TEEN                     = DFB_KEY( SPECIAL, 0x6E ),
     DIKS_TWEN                     = DFB_KEY( SPECIAL, 0x6F ),

     DIKS_BREAK                    = DFB_KEY( SPECIAL, 0x70 ),
     DIKS_EXIT                     = DFB_KEY( SPECIAL, 0x71 ),
     DIKS_SETUP                    = DFB_KEY( SPECIAL, 0x72 ),

     DIKS_CURSOR_LEFT_UP           = DFB_KEY( SPECIAL, 0x73 ),
     DIKS_CURSOR_LEFT_DOWN         = DFB_KEY( SPECIAL, 0x74 ),
     DIKS_CURSOR_UP_RIGHT          = DFB_KEY( SPECIAL, 0x75 ),
     DIKS_CURSOR_DOWN_RIGHT        = DFB_KEY( SPECIAL, 0x76 ),

     DIKS_PIP                      = DFB_KEY( SPECIAL, 0x77 ),
     DIKS_SWAP                     = DFB_KEY( SPECIAL, 0x78 ),
     DIKS_FREEZE                   = DFB_KEY( SPECIAL, 0x79 ),
     DIKS_MOVE                     = DFB_KEY( SPECIAL, 0x7A ),
     DIKS_STILL                    = DFB_KEY( SPECIAL, 0x7B ),
     DIKS_PICTURE_MODE             = DFB_KEY( SPECIAL, 0x7C ),
     DIKS_SOUND_MODE               = DFB_KEY( SPECIAL, 0x7D ),
     DIKS_3DSTEREO                 = DFB_KEY( SPECIAL, 0x7E ),

     DIKS_CALL                     = DFB_KEY( SPECIAL, 0x7F ),
     DIKS_SPEAKER                  = DFB_KEY( SPECIAL, 0x80 ),
     DIKS_SAVE                     = DFB_KEY( SPECIAL, 0x81 ),
     DIKS_REDIAL                   = DFB_KEY( SPECIAL, 0x82 ),
     DIKS_FLASH                    = DFB_KEY( SPECIAL, 0x83 ),
     DIKS_HOLD                     = DFB_KEY( SPECIAL, 0x84 ),
